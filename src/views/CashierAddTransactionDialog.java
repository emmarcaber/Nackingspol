 ...
 * @author Anaclita
 */
public class CashierAddTransactionDialog extends javax.swing.JDialog {
     ...
     */
    public CashierAddTransactionDialog(java.awt.Frame parent, boolean modal, int cashierID) {
        super(parent, modal);
        initComponents();
        ...
        if (cbCustomer.getSelectedIndex() == 0) {
            ...
            if (insertedTransactionID == 0) {
                ...
                String[] data = {
                    ...
                    "Php " + total, transactionType, transactionDate
                };
