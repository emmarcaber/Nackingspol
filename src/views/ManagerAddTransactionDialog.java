...
public class ManagerAddTransactionDialog extends javax.swing.JDialog {
        ...
        if (cbCustomer.getSelectedIndex() == 0) {
            ...
            if (insertedTransactionID == 0) {
                ...
                String[] data = {
                    ...
                    "Php " + total, transactionType, dateOfTransaction
                };
    ...
    private int insertTransactionToDB(int customerID, int userID, int productID, int quantity, float total, String typeOfTransaction, String dateOfTransaction) {
        ...
        try {
            String sql = "INSERT INTO transactions(CustomerID, CashierID, ProductID, Quantity, Total, TransactionType, TransactionDate) "
                    + "VALUES(?, ?, ?, ?, ?, ?, ?)";
