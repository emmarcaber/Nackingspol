...
public class EditCashierDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtOldPassword.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        txtConfirmPassword.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N

        jLabel13.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel13.setText("New Password");

        txtNewPassword.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (firstName.equals("")) {
            ...
            if (rowAffected > 0) {
                ...
                tblModel.setValueAt(data[0], AdminCashierPanel.tblCashier.getSelectedRow(), 0);
                tblModel.setValueAt(data[1], AdminCashierPanel.tblCashier.getSelectedRow(), 1);
                ...
                WriteLogs.writeLog("Edited Cashier ID: " + cashierID);
                System.out.println("Edited Cashier ID: " + cashierID);
